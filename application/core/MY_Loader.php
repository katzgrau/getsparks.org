...
class MY_Loader extends CI_Loader
{
    ...
    /**
     * Override the CI autoloader so we can include autoloading of sparks
     */
    function  _ci_autoloader()
    {
        parent::_ci_autoloader();

        // This was already done in the parent, but we need to get it again
	 ...
	 * @return	void
	 */
	function _ci_path_autoloader($basepath)
	{
